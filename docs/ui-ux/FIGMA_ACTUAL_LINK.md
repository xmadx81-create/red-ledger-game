...
```text
헌혈센터처럼 보이는 혈연센터를 운영하며,
그 이면에서 뱀파이어 가문의 비밀 혈액 수급망을 관리하는
다크 행정 누아르 운영 시뮬레이션
```
...
- 장부, 봉인 문서, 재고표, 보고서 중심의 UI
- 표면 업무와 이면 보고가 겹쳐지는 구조
...
1. SCR-010 최종 평가 화면 추가
2. 자원 바 컴포넌트 정리
3. 선택지 카드 컴포넌트 정리
4. 보고서 카드 컴포넌트 정리
5. Google Sheets `08_UI화면목록`과 Figma 프레임명 연결 검토
